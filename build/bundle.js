var app = (function () {
    ...
    /* src/Progress.svelte generated by Svelte v3.32.0 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-126gjq7");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-126gjq7");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/Timer.svelte generated by Svelte v3.32.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	progress_1 = new Progress({ props: { progress: /*progress*/ ctx[2] } });
    ...
    /* src/HowTo.svelte generated by Svelte v3.32.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="hadwashing.jpg" alt="Wash Hands" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("endTimer", /*timerEnds*/ ctx[1]);
    	howto = new HowTo({});

    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Wash Up!";
    			t1 = space();
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Pic Source</a> 
